...
const Footer = () => {
    return (
        <footer className='max-padd-container mb-4'>
            <div className='max-padd-container bg-primary rounded-3xl pt-12 xl:pt-20 pb-8'>
                ...
                <div className='flex justify-between flex-wrap gap-x-2 gap-y-8'>
                    <div className='max-w-sm'>
                        <Link to={'/'} className='flex items-center gap-x-2'><span className='font-[900] text-[24px]'>Aakash<span className='font-[600] medium-20'>Territory</span></span></Link>
                        <p className='py-4'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Amet quos sunt recusandae quibusdam minus voluptate laudantium sint ut. Libero cupiditate cumque maiores sequi earum, iste saepe ea rem distinctio voluptatibus autem placeat.</p>
            ...
            {/* copyright */}
            <p className='text-white bg-tertiary medium-14 py-2 px-8 rounded-b-3xl flexBetween'><span>2024 AakashProperties</span>All rights reserved</p>
        </footer>
    )
}
